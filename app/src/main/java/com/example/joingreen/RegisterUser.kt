...
class RegisterUser : AppCompatActivity() {
    ...
    private fun saveUserToFirebaseDatabase(profileImageUrl: String) {
        ...
        val user = User(uid,profileImageUrl,userName.text.toString(),email.text.toString(),password.text.toString(),address.text.toString())
...
class User(val uid: String, val profileImageUrl: String,val userName:String,val LoginId: String,val password:String, val address :String)
